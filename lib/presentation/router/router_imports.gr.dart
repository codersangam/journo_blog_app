...
abstract class $AppRouter extends _i13.RootStackRouter {
  ...
  final Map<String, _i13.PageFactory> pagesMap = {
    ...
    UpdateTagsRoute.name: (routeData) {
      ...
      return _i13.AutoRoutePage<_i14.TagsModel>(
        routeData: routeData,
    ...
    AddCategoriesRoute.name: (routeData) {
      return _i13.AutoRoutePage<_i15.CategoriesModel>(
        routeData: routeData,
        child: const _i9.AddCategories(),
      );
    },
    ...
    GeneralRoute.name: (routeData) {
      return _i13.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i11.General(),
      );
    },
    OnBoardRoute.name: (routeData) {
      return _i13.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i12.OnBoard(),
      );
    },
  };
}
